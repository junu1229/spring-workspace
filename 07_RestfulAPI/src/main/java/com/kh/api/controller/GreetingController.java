...
public class GreetingController {
	...
	// http://locahost:8081/api/greet --> selectList
	@GetMapping("/greet")
	...
	// --> http://localhost:8080/board/23-->selectPme
	...
	@GetMapping("/greet2")
	public Greeting sayGreey2(String content) {
		return new Greeting(500l, "오후 3시 39분");
	}
}
